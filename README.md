...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pint-pandas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10408&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pint-pandas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pint-pandas` can be installed with:

```
conda install pint-pandas
```

It is possible to list all of the versions of `pint-pandas` available on your platform with:
